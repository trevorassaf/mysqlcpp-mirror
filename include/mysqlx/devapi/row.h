...
/**
  ...
  common::Values of fields can be accessed with `get()` method or using
...
public:
  ...
  */
  ...
  common::Value& get(col_count_t pos)
  {
    try {
  ...
  */
  ...
  common::Value& set(col_count_t pos, const common::Value &val)
  {
    try {
  ...
  */
  ...
  const common::Value& operator[](col_count_t pos) const
  {
  ...
  */
  ...
  common::Value& operator[](col_count_t pos)
  {
    ensure_impl();
    try {
      return get(pos);
