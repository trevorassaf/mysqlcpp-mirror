...
public:
  ...
  */
  ...
  Result replaceOne(const string &id, common::Value &&document)
  {
    try {
      return
  ...
  */
  ...
  Result addOrReplaceOne(const string &id, common::Value &&document)
  {
    try {
      return
...
public:
  ...
  */
  ...
  /**
    ...
    Specify column names as method arguments. common::Values are inserted only into
